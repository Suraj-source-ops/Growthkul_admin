...
<head>
    ...
    <meta name="description" content="Welcome Mail.">
    <style type="text/css">
        a:hover {
                        ...
                        <td>
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h3
                                            style="color:#1e1e2d; font-weight:500; margin:0;font-size:18px;font-family:'Rubik',sans-serif;">
                                            Login Credetials</h3>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        ...
                                        <p><span><b>Password :</b> </span>{{$password}}</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
                                ...
                                <tr>
                                    <td>
                                        <p><span><b>NOTE :</b> </span> Please don't share your credentials to anyone.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
