<div class="row">
    ...
    <div class="col-md-12 comment-history-main-box">
        <div class="comment-history-btn">
            <button type="button" class="comman-btn" id="techpack-comment-btn">Comment</button>
            <button type="button" class="border-comman-btn" id="techpack-history-btn">History</button>
        </div>
        <div class="comment-section" id="view-techpack-comment">
            @include('products.viewpartials.commentAndHistory.comment.comment',
            [
            'productId'=>$productId,
            'type'=>$prodtype,
            'comments' => $comments
        ...
        <div class="history-section d-none" id="view-teckpack-history">
            @include('products.viewpartials.commentAndHistory.history.history',
            [
            'productId'=>$productId,
            'type'=>$prodtype
            ])
