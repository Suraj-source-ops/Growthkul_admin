{{-- <div id="techPack" class="tab-pane fade"> --}}
    <form action="{{route('update.product.details',['slug'=> $product->slug,'type' => 2])}}" method="POST"
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="input_box">
                    ...
                    {{-- <input type="file" name="product_files[]" id="techPackattachment" multiple /> --}}
                    <input type="file" onchange="startTechPackattachmentChunkUpload(this)"
                        data-productid="{{$product->id}}" id="techPackInputFile" />
                </div>
                <div id="upload-progress-wrapper-techpack"
                    style="display:none; margin-top: 10px; margin-bottom: 10px;">
                    <span id="upload-status-text-techpack" style="font-weight: bold; font-size:14px;"></span>
                    <div
                        style="width: 100%; background: #f1f1f1; border-radius: 4px; overflow: hidden; margin-top: 5px;">
                        <div id="upload-progress-bar-techpack" style="height: 10px; width: 0%; background: #4CAF50;">
                        </div>
                    </div>
                    <button id="cancel-upload-btn-techpack" class="comman-btn"
                        onclick="cancelProductUploadTechPack(event)" style="margin-top: 8px;">Cancel
                        Upload</button>
                </div>
                <input type="hidden" name="product_files" id="productfiles-techpack" value="">
            </div>
            <div class="col-md-12">
                <div class="file-upload-box">
                    <h3>Product Files</h3>
                    <div class="row" id="tech-pack-uploaded-files-wrapper">
