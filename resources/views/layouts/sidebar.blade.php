            ...
            <div class="top-content">
                ...
                <div id="main">
                    <div class="accordion" id="faq">
                        ...
                        @endcan
                        @can('view-service-section-sidebar')
                            <div class="car">
                                    ...
                                    <div id="settingsDrop3" class="collapse" aria-labelledby="Settings3" data-parent="#faq">
                                        <div class="card-body sidebar_drop_body">
                                            @can('view-service-details-sidebar')
                                                <li class="">
                            ...
                            @endcan
                            @can('view-enquiry-section-sidebar')
                                <li class="">
                            ...
                            @endcan
                            @can('view-project-section-sidebar')
                                <li class="">
                            ...
                            @endcan
                            @can('view-blogs-section-sidebar')
                                <li class="">
                                    <a href="{{ route('blogs') }}"
